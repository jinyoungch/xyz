  ...
  return (
    <ThemeProvider defaultTheme="dark" disableTransitionOnChange>
      <Head>
        ...
        <meta name="description" property="og:description" content="self-proclaimed interesting human bean 🫘" />
        <meta property="og:description" content="self-proclaimed interesting human bean 🫘" />
